...
const MyCart = ({ reloadnavbar, setreloadnavbar }) => {
  ...
  const getcartitemsfromlocalstorage = () => {
    ...
    if (cart) {
      ...
      let tempsubtotal = 0
      cart.forEach(item => {
        tempsubtotal += item.productdata.ProductPrice * item.quantity
      })
  ...
  return (
    <Stack>
      ...
      <Box className='cart' sx={{display: "flex", flexDirection: "column", alignItems: "center"}}>
        <Box sx={{display: "flex", flexDirection: "row", justifyContent: "space-between", margin: "20px",  minHeight: "80px",width: "50%", borderRadius: "10px", boxShadow: " 0 0 10px rgba(0, 0, 0, 0.383)", padding: "0px 10px", alignItems: "center"}}>
          {
            active == 1 ?
              <div className='c11' style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}
                onClick={() => {
                  cartdata.length > 0 && checklogin() && setactive(1)
                }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" style={{width: "30px", height: "30px", cursor: "pointer", color: "yellowgreen"}}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                </svg>
                <span style={{fontSize: "16px", fontWeight:"400", color: "yellowgreen", cursor: "pointer"}}>My Cart</span>

              </div>
              :
              <div className='c1' style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}
                onClick={() => {
                  cartdata.length > 0 && checklogin() && setactive(1)
                }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" style={{width: "30px", height: "30px", cursor: "pointer", color: "#3371d3"}}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                </svg>
                <span style={{fontSize: "16px", fontWeight:"400", color: "#3371d3", cursor: "pointer"}}>My Cart</span>
              </div>
          }
...

          {
            active == 2 ?
              ...
              >
                ...
                <span style={{fontSize: "16px", fontWeight:"400", color: "yellowgreen", cursor: "pointer"}}>Shipping</span>
              ...
              >
                ...
                <span style={{fontSize: "16px", fontWeight:"400", color: "#3371d3", cursor: "pointer"}}>Shipping</span>
              </div>
          }

          {
            active == 3 ?
              ...
              >
                ...
                <span style={{fontSize: "16px", fontWeight:"400", color: "yellowgreen", cursor: "pointer"}}>Payment</span>
              ...
              >
                ...
                <span style={{fontSize: "16px", fontWeight:"400", color: "#3371d3", cursor: "pointer"}}>Payment</span>
              </div>
          }
          {
            active == 4 ?
              ...
              >
                ...
                <span style={{fontSize: "16px", fontWeight:"400", color: "yellowgreen", cursor: "pointer"}}>Success</span>
              ...
              >
                ...
                <span style={{fontSize: "16px", fontWeight:"400", color: "#3371d3", cursor: "pointer"}}>Success</span>
              </div>
          }
        </Box>
